module ReadWrite_buffer(clk,AEN,IOW,IOR,address_in_4,TC,MEMWR,add_inc_dec,autoinitialization,ch_select,address_WB,word_WB,base_address,base_word,CURRENT_address,Read_buffer,conc_flag_out,IOflag,mem2mem,flag_mem,myBus);
...
input clk,autoinitialization,add_inc_dec,MEMWR,IOR,IOW,AEN,conc_flag_out,IOflag,mem2mem,myBus;
...
if(add_inc_dec == 1)
begin
current_address[ch_select] <= current_address[ch_select] - 1;
...
else if(current_word[flag_mem] > 0 && mem2mem == 1 && hold_address == 0)
begin
hold_address <= 1 ;
if(flag_mem == 0)
begin
...
if(add_inc_dec == 1)
begin
current_address[flag_mem] <= current_address[flag_mem] - 1;
